...
import RC.model as train
import os
def add_arguments(parser):
    """Build ArgumentParser."""
    parser.add_argument("--src", type=str, default='in')
    parser.add_argument("--tgt", type=str, default='out')
    parser.add_argument("--train_prefix", type=str, default='../data/predicate_prediction/train')
    parser.add_argument("--dev_prefix", type=str, default='../data/predicate_prediction/dev')
    parser.add_argument("--test_prefix", type=str, default='../data/predicate_prediction/test')
    parser.add_argument("--vocab_prefix", type=str, default='../data/predicate_prediction/vocab')
...
def extend_hparams(hparams):
    ...
    hparams.vocab_src=hparams.vocab_prefix+'.'+hparams.src
    hparams.vocab_tgt=hparams.vocab_prefix+'.'+hparams.tgt
    
def infer(path):
    """Build inference model for relation classify
    Args:
